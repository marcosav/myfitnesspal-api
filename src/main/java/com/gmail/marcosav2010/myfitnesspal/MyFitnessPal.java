...
import com.gmail.marcosav2010.myfitnesspal.lister.CustomFoodFormater;
import com.gmail.marcosav2010.myfitnesspal.lister.FoodList;
import com.gmail.marcosav2010.myfitnesspal.lister.ListerData;
...
public class MyFitnessPal {
	...
	private static void generateList(ListerData lc, String jsonSession, String option, String day, String month, String year, String meals) throws IOException {
		generateList(MFPSession.from(jsonSession), lc, option, day, month, year, meals);
	}
